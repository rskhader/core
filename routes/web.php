...
// Route::get('/get-sub-sections/{sectionId}', [CustodyController::class, 'getSubSections']);
...
Route::prefix('/')->group(function () {
    // **************************DieselExport********************************************************************
    Route::get('dieselexportfilter', [DieselExportController::class, 'report']);
    Route::get('totalreport', [DieselExportController::class, 'totalreport']);
    Route::post('dieselexport/searchdate', [DieselExportController::class, 'searchdate']);
    Route::post('dieselexport/searchvou', [DieselExportController::class, 'searchvou']);
    Route::post('dieselexport/searchsec', [DieselExportController::class, 'searchsec']);
    Route::post('dieselexport/searchname', [DieselExportController::class, 'searchname']);
    Route::post('dieselexport/searchtotal', [DieselExportController::class, 'searchtotal']);
    // **************************Diesel********************************************************************
    Route::get('dieselfilter', [DieselController::class, 'report']);
    Route::post('diesel/searchdate', [DieselController::class, 'searchdate']);
    Route::post('diesel/searchvou', [DieselController::class, 'searchvou']);
    // **************************legal********************************************************************
...
Route::prefix('/historical')->group(function () {
    Route::get('exportindex', [HistoricalController::class, 'exportindex']);
    Route::get('exportreport', [HistoricalController::class, 'exportreport']);
    Route::get('totalreport', [HistoricalController::class, 'totalreport']);
    Route::post('searchdate', [HistoricalController::class, 'searchdate']);
    Route::post('searchvou', [HistoricalController::class, 'searchvou']);
    Route::post('searchsec', [HistoricalController::class, 'searchsec']);
    Route::post('searchname', [HistoricalController::class, 'searchname']);

    Route::post('searchtotal', [HistoricalController::class, 'searchtotal'])->name('searchtotal');

    Route::get('waredindex', [HistoricalController::class, 'waredindex']);
    Route::get('waredreport', [HistoricalController::class, 'waredreport']);
    Route::post('datewared', [HistoricalController::class, 'datewared']);
});
