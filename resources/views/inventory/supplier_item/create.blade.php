                                    ...
                                    <div class="ml-5 btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                            <ul class="nav nav-hover flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="http://127.0.0.1:8000/inventory/category/create"
                                                        class="nav-link">
                                                ...
                                                <li class="nav-item">
                                                    <a href="http://127.0.0.1:8000/inventory/item/create"
                                                        class="nav-link">
                                                        <i class="nav-icon flaticon2-add-1"></i> إضافة صنف
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="http://127.0.0.1:8000/inventory/store/create"
                                                        class="nav-link">
                                                        <i class="nav-icon flaticon2-add-1"></i> إضافة مخزن
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="http://127.0.0.1:8000/inventory/supplier_item/create"
                                                        class="nav-link">
                                                        <i class="nav-icon flaticon2-add-1"></i> إضافة مورد
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="http://127.0.0.1:8000/inventory/import_item/create"
                                                        class="nav-link">
                                                        <i class="nav-icon flaticon2-add-1"></i> إضافة صنف وارد
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="http://127.0.0.1:8000/inventory/export_item/create"
                                                        class="nav-link">
                                                        <i class="nav-icon flaticon2-add-1"></i> إضافة صنف صادر
                                                    </a>
                                                </li>
                                                <li class="nav-item">
                                                    <a href="http://127.0.0.1:8000/inventory/Custody_item/create"
                                                        class="nav-link">
