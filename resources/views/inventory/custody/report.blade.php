...
@section('content')
    ...
    @csrf
            <div class="form-group row">
                <label for="start_date" class="col-form-label"><h5><strong>تاريخ البدء :</strong></h5> </label>
                <div class="col-3 pr-5">
                    <input name="start_date" type="date" class="form-control" id="start_date"/>
                </div>

                <label for="end_date" class="col-form-label"><h5><strong>تاريخ الإنتهاء :</strong></h5> </label>
                <div class="col-3 pr-5">
        ...
        <div class="card text-center">
            ...
            <div class="card-body">
                ...
                <tr>
                  ...
                  <td>
                     {{ \App\Models\Diesel::count('id') }}</li></td>
                  <td>  {{ \App\Models\Diesel::sum('quantity') }} <span>لتر</span> </li></td>
