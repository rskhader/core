    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                <form action="{{route('diesel.update', $diesel->id)}}" method="post" class="needs-validation" novalidate
                  ...
                  {!! csrf_field() !!}
                    <div class="card-body" style="margin:20px;" >
                        ...
                        <div class="form-group row pb-5">
                            ...
                            <div class="col-lg-3">
                                <div class="input-group">
                                    <input name="quantity" id="quantity" type="number" class="form-control"  min="0"  value="{{ $diesel->quantity }}">
                                </div>
                            </div>
                            <label for="type" class="col-lg-2 col-form-label text-lg-right">جهة التوريد:</label>
                            <div class="col-lg-3">
                                <div class="input-group">
                                    <input  name="type"  id="type" type="text" class="form-control"  value="{{ $diesel->type }}">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row pb-5">
                            ...
                            <div class="col-lg-3">
                                <div class="input-group">
                                    <input  name="invoice_num" type="number" min="0" class="form-control" id="invoice_num" value="{{ $diesel->invoice_num }}"/>
                                </div>
                            </div>
                            <label for="voucher" class="col-lg-2 col-form-label text-lg-right">سند التوريد:</label>
                            <div class="col-lg-3">
                                <div class="input-group">
                                    <input  name="voucher" type="number" min="0" class="form-control" id="voucher"  value="{{ $diesel->voucher }}" />       
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-3">
                                <div class="input-group">
                                    <input  name="date" type="date"  class="form-control" id="date"  value="{{ $diesel->date }}" />
                                </div>
                            </div>
