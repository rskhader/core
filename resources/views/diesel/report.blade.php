    ...
    <div class="card card-custom">
        <div class="card-header flex-wrap border-0 pt-5 pb-0">
            <div class="card-title">
                <h3 class="card-label">تقارير وارد السولار </h3>
            </div>
                ...
                <div class="card-body1 row">
                            ...
                            <div class="col-lg-5 mb-6">
                                ...
                                <form action="{{ url('diesel/searchvou') }}" method="POST" class="form-group pr-5">
                                    ...
                                    <div class="input-daterange input-group">
                                        <div class="col-4 p-0">
                                            <input name="start_voucher" type="text" class="form-control" id="start_voucher" />
                                        </div>
                                        <div class="input-group-append">
                                            <span class="input-group-text"><i class="la la-ellipsis-h"></i></span>
                                        </div>
    ...
    <!-- search date /-->
        ...
        <div class="card-body">
            <table id="example" class="table table-striped dt-responsive " style="width:100%">
                ...
                <tfoot>
                    <tr>
                        <th style="font-size:12px; font-weight: bold; ">{{ 'مجموع السولار  الوارد ' }}</th>
                    ...
                    <tr>
                        <td>
                            {{-- <li class="list-group-item">   --}}
                                {{ \App\Models\Diesel::select('quantity')->whereRaw('YEAR(diesels.date) = 2022')->sum('quantity') -\App\Models\DieselExport::select('quantity')->whereRaw('YEAR(diesel_exports.date) = 2022')->sum('quantity') }}                                <span>لتر</span>
                            </li>
                        </td>
