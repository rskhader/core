                                    ...
                                    @can('diesels')
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                                            <a href="javascript:;" class="menu-link menu-toggle">
                                                ...
                                                <span class="menu-text">السولار</span>
                                                <i class="menu-arrow"></i>
                                            </a>
                                            <div class="menu-submenu">
                                                <i class="menu-arrow"></i>
                                                                ...
                                                                <ul class="menu-subnav">
                                                                    ...
                                                                    <li class="menu-item" aria-haspopup="true">
                                                                        <a href="{{ url('/diesel/create') }}"
                                                                            ...
                                                                            <span class="menu-text">إضافة وارد السولار</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="menu-item" aria-haspopup="true">
                                                                        <a href="{{ url('/diesel') }}" class="menu-link">
                                                                            <span class="svg-icon menu-icon">
                                                                                <i class="flaticon-eye"></i>
                                                                                <!--end::Svg Icon-->
                                                                            </span>
                                                                            <span class="menu-text">عرض وارد السولار</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="menu-item" aria-haspopup="true">
                                                                        <a href="{{ url('/dieselfilter') }}"
                                                                            class="menu-link">
                                                                            <i class="menu-bullet menu-bullet-dot">
                                                                                <span></span>
                                                                            </i>
                                                                            <span class="menu-text">تقارير الوارد</span>
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        ...
                                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                                            ...
                                                            <div class="menu-submenu">
                                                                ...
                                                                <ul class="menu-subnav">
                                                                    ...
                                                                    <li class="menu-item" aria-haspopup="true">
                                                                        <a href="{{ url('/dieselexport/create') }}"
                                                                            class="menu-link">
                                                                            <span class="svg-icon menu-icon">
                                                                                <i class="flaticon-add-circular-button"></i>
                                                                                <!--end::Svg Icon-->
                                                                            </span>
                                                                            <span class="menu-text">إضافة صادر السولار</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="menu-item" aria-haspopup="true">
                                                                        <a href="{{ url('/dieselexport') }}"
                                                                            class="menu-link">
                                                                            <span class="svg-icon menu-icon">
                                                                                <i class="flaticon-eye"></i>
                                                                                <!--end::Svg Icon-->
                                                                            </span>
                                                                            <span class="menu-text">عرض صادر السولار</span>
                                                                        </a>
                                                                    </li>
                                                                    <li class="menu-item" aria-haspopup="true">
                                                                        <a href="{{ url('/dieselexportfilter') }}"
                                                                            class="menu-link">
                                                                            <i class="menu-bullet menu-bullet-dot">
                                                                                <span></span>
                                                                            </i>
                                                                            <span class="menu-text">تقارير الصادر</span>
                                                                        </a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                                        ...
                                                                        <li class="menu-item menu-item-submenu"
                                                                            ...
                                                                            <div class="menu-submenu">
                                                                                ...
                                                                                <ul class="menu-subnav">
                                                                                    ...
                                                                                    <li class="menu-item"
                                                                                        aria-haspopup="true">
                                                                                        <a href="{{ url('/historical/waredindex') }}"
                                                                                            class="menu-link">
                                                                                            <i
                                                                                                class="menu-bullet menu-bullet-dot">
                                                                                                <span></span>
                                                                                            </i>
                                                                                            <span class="menu-text">عرض الملف
                                                                                                التاريخي
                                                                                                للوارد</span>
                                                                                        </a>
                                                                                    </li>
                                                                        ...
                                                                        <li class="menu-item menu-item-submenu"
                                                                            ...
                                                                            <div class="menu-submenu">
                                                                                ...
                                                                                <ul class="menu-subnav">
                                                                                    ...
                                                                                    <li class="menu-item"
                                                                                        aria-haspopup="true">
                                                                                        <a href="{{ url('/historical/exportindex') }}"
                                                                                            class="menu-link">
                                                                                            <i
                                                                                                class="menu-bullet menu-bullet-dot">
                                                                                                <span></span>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/unit/create') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-add-circular-button"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/unit') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-eye"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/category/create') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-add-circular-button"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/category') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-eye"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/item/create') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-add-circular-button"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                    ...
                                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                        ...
                                        <div class="menu-submenu">
                                            ...
                                            <ul class="menu-subnav">
                                                ...
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="{{ url('/inventory/store/create') }}" class="menu-link">
                                                        <span class="svg-icon menu-icon">
                                                            <i class="flaticon-add-circular-button"></i>
                                                            <!--end::Svg Icon-->
                                                        </span>

                                                        <span class="menu-text">إضافة مخزن </span>
                                                    </a>
                                                </li>
                                                <li class="menu-item" aria-haspopup="true">
                                                    <a href="{{ url('/inventory/store') }}" class="menu-link">
                                                        <span class="svg-icon menu-icon">
                                                            <i class="flaticon-eye"></i>
                                                            <!--end::Svg Icon-->
                                                        </span>
                                                        <span class="menu-text">عرض المخازن </span>
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/supplier_item') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-eye"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/subSection/create') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-add-circular-button"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/subSection') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-eye"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/invoice/create') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-add-circular-button"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/invoice') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-eye"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/invoice_export') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-eye"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/custody/create') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-add-circular-button"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/custody') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-eye"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/totalreport') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-eye"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                        ...
                                        <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                            ...
                                            <div class="menu-submenu">
                                                ...
                                                <ul class="menu-subnav">
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/currency/create') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-eye"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                                    ...
                                                    <li class="menu-item" aria-haspopup="true">
                                                        <a href="{{ url('/inventory/currency') }}" class="menu-link">
                                                            <span class="svg-icon menu-icon">
                                                                <i class="flaticon-eye"></i>
                                                                <!--end::Svg Icon-->
                                                            </span>
                                                    ...
                                                    <li class="menu-item menu-item-submenu" aria-haspopup="true"
                                                        ...
                                                        <div class="menu-submenu">
                                                            ...
                                                            <ul class="menu-subnav">
                                                                ...
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{ url('/court/court_order') }}"
                                                                        class="menu-link">
                                                                        <span class="svg-icon menu-icon">
                                                                            <i class="flaticon-eye"></i>
                                                                            <!--end::Svg Icon-->
                                                                        </span>
                                                                        <span class="menu-text">طلب تنفيذي</span>
                                                                    </a>
                                                                </li>
                                                                {{-- قبل الحجز --}}
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{ url('/court/B_all_amount') }}"
                                                                        class="menu-link">
                                                                        <span class="svg-icon menu-icon">
                                                                            <i class="flaticon-eye"></i>
                                                                            <!--end::Svg Icon-->
                                                                        </span>
                                                                        <span class="menu-text">دفع كلي</span>
                                                                    </a>
                                                                </li>
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{ url('/court/B_part_amount') }}"
                                                                        class="menu-link">
                                                                        <span class="svg-icon menu-icon">
                                                                            <i class="flaticon-eye"></i>
                                                                            <!--end::Svg Icon-->
                                                                        </span>
                                                                        <span class="menu-text">تقسيط المبلغ</span>
                                                                    </a>
                                                                </li>
                                                                {{-- بعد الحجز --}}
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{ url('/court/A_part_amount') }}"
                                                                        class="menu-link">
                                                                        <span class="svg-icon menu-icon">
                                                                            <i class="flaticon-eye"></i>
                                                                            <!--end::Svg Icon-->
                                                                        </span>
                                                                        <span class="menu-text">إنهاء أمر الحبس</span>
                                                                    </a>
                                                                </li>
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{ url('/court/A_end_detention') }}"
                                                                        class="menu-link">
                                                                        <span class="svg-icon menu-icon">
                                                                            <i class="flaticon-eye"></i>
                                                                            <!--end::Svg Icon-->
                                                                        </span>
                                                                        <span class="menu-text">تقسيط المبلغ بعد
                                                                            الحجز</span>
                                                                    </a>
                                                                </li>
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{ url('/court/A_all_amount') }}"
                                                                        class="menu-link">
                                                                        <span class="svg-icon menu-icon">
                                                                            <i class="flaticon-eye"></i>
                                                                            <!--end::Svg Icon-->
                                                                        </span>
                                                                        <span class="menu-text">دفع كلي بعد الحجز</span>
                                                                    </a>
                                                                </li>
                                                                {{-- أوامر الحجز --}}
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{ url('/court/detention_order') }}"
                                                                        class="menu-link">
                                                                        <span class="svg-icon menu-icon">
                                                                            <i class="flaticon-eye"></i>
                                                                            <!--end::Svg Icon-->
                                                                        </span>
                                                                        <span class="menu-text"> أمر الحبس</span>
                                                                    </a>
                                                                </li>
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{ url('/court/salary_reservation') }}"
                                                                        class="menu-link">
                                                                        <span class="svg-icon menu-icon">
                                                                            <i class="flaticon-eye"></i>
                                                                            <!--end::Svg Icon-->
                                                                        </span>
                                                                        <span class="menu-text">حجز راتب</span>
                                                                    </a>
                                                                </li>
                                                                <li class="menu-item" aria-haspopup="true">
                                                                    <a href="{{ url('/court/travel_ban') }}"
                                                                        class="menu-link">
                                                                        <span class="svg-icon menu-icon">
                                                                            <i class="flaticon-eye"></i>
                                                                            <!--end::Svg Icon-->
                                                                        </span>
                                                                        <span class="menu-text">منع سفر</span>
                                                                    </a>
                                                                </li>
                                                            </ul>
                                                        </div>
