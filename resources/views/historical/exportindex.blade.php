        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                ...
                <div class="card-toolbar">
                        ...
                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                            ...
                            <ul class="navi flex-column navi-hover py-2">
                                <li class="navi-header font-weight-bolder text-uppercase font-size-sm text-primary pb-2">
                                    اختر:</li>
                                <li class="navi-item">
                                    <a href="https://master/CoreArchive/public/historical/exportreport" class="navi-link">
                    ...
                    <!--end::Dropdown-->
                    <!--begin::Button-->
                    <a href="https://master/CoreArchive/public/dieselexport/create" class="btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
                ...
                <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                    <thead>
                        <tr>
                            ...
                            <th title="Field #6">{{ 'رقم الدفتر' }}</th>
                            <th title="Field #5">{{ 'كمية الصادر' }}</th>
                            <th title="Field #4">{{ 'رقم السند' }}</th>
                    ...
                    <tbody class="datatable-body">
                        @foreach ($dieselexport as $dieselexports)
                            ...
                            style="width: 10px;">{{$dieselexports->id}}</span></td> --}}
                                <td data-field="name_section" aria-label="0374-5070" class="datatable-cell">
                                    {{ $dieselexports->section->name_section }}</span></td>

                                <td data-field="subSection_id" aria-label="0374-5070" class="datatable-cell"><span
                                        style="width: 137px;">{{ $dieselexports->sub_section_id }}</span></td>

                                <td data-field="num_section" aria-label="0374-5070" class="datatable-cell"><span
                                        style="width: 137px;">{{ $dieselexports->num_section }}</span></td>

                                <td data-field="num_note" aria-label="0374-5070" class="datatable-cell"><span
                                        style="width: 137px;">{{ $dieselexports->num_note }}</span></td>

                                <td data-field="quantity" aria-label="0374-5070" class="datatable-cell">
                                    <span style="width: 137px;">{{ $dieselexports->quantity }}</span>
                                </td>
                                <td data-field="voucher" aria-label="0374-5070" class="datatable-cell"><span
                                        style="width: 137px;">{{ $dieselexports->voucher }}</span></td>

                                <td data-field="date" aria-label="0374-5070" class="datatable-cell"><span
                                        style="width: 137px;">{{ $dieselexports->date }}</span></td>
