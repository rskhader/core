    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card card-custom gutter-b example example-compact">
                ...
                <!--begin::Form-->
                <form action="{{ route('archiveExport.update',$archiveExport->id) }}" method="post" class="needs-validation" novalidate enctype="multipart/form-data">
                @csrf
                {!! csrf_field() !!}
                @method('PUT')
                    <div class="card-body" >
                      ...
                      <div class="form-group row p-3">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input name="title" id="title" type="text" class="form-control"  min="0"  value="{{ $archiveExport->title }}" >
                                </div>
                            </div>
                      </div>
  
                        <div class="form-group row p-3">
                            <label for="export_id" class="col-lg-2 col-form-label "><h6><strong>الجهة الصادر إليها:</strong></h6></label>
                            <div class="col-lg-9">
                        ...
                        <div class="form-group row p-3">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input  name="number" type="number" min="0" class="form-control" id="number" value="{{ $archiveExport->number }}"  />
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group row p-3">
                            ...
                            <div class="col-lg-9">
                                <div class="input-group">
                                    <input  name="date" type="date"  class="form-control" id="date"  value="{{ $archiveExport->date }}"  />
                                </div>
                            </div>
                        </div>
