                    ...
                    <form action="{{ route('dieselexport.store') }}" method="post" class="form needs-validation "
                        ...
                        <div class="card-body" style="margin:20px;">
                            <div class="form-group row pb-5">
                                ...
                                <div class="col-3">
                                    <div class="dropdown bootstrap-select form-control dropup">
                                        <select class="@error('section_id') is-invalid @enderror form-control selectpicker " data-size="7" tabindex="null"
                            ...
                            <div class="form-group row pb-5">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group">
                                        <input name="num_section" id="num_section" type="number" class="@error('num_section') is-invalid @enderror form-control"
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group">
                                        <input name="num_note" id="num_note" type="number" class="@error('num_note') is-invalid @enderror form-control"
                            ...
                            <div class="form-group row pb-5">
                                ...
                                <div class="col-lg-3">
                                    <div class="input-group">
                                        <input name="quantity" id="quantity" type="number" class="@error('quantity') is-invalid @enderror form-control"
                                            min="0" placeholder="ادخل كمية الصادر">
                                    </div>
                                </div>
                                <label for="voucher" class="col-lg-2 col-form-label text-lg-right">سند الصادر:</label>
                                <div class="col-lg-3">
                                    <div class="input-group">
                                        <input name="voucher" type="number" min="0" class="@error('voucher') is-invalid @enderror form-control"
                                            id="voucher" placeholder="ادخل سند الصادر" />
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-sm dropdown-menu-right">
                                            <ul class="nav nav-hover flex-column">
                                                ...
                                                <li class="nav-item">
                                                    <a href="https://master/CoreArchive/public/section/create"
                                                        class="nav-link">
