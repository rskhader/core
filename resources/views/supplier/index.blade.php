            ...
            <div class="flex-wrap pt-6 pb-0 border-0 card-header">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="mr-2 dropdown dropdown-inline">
                        <a href="https://master/CoreArchive/public/diesel/create" class="btn btn-success font-weight-bolder">
                    ...
                    <!--end::Dropdown-->
                    <!--begin::Button-->
                    <a href="https://master/CoreArchive/public/supplier/create" class="btn btn-primary font-weight-bolder">
                        <span class="svg-icon svg-icon-md">
